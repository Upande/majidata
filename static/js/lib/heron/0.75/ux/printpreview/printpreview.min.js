...
Ext.namespace("GeoExt.ux");GeoExt.ux.PrintPreview=Ext.extend(Ext.Container,{paperSizeText:"Format:",resolutionText:"Resolution:",printText:"Print",emptyTitleText:"Enter map title here.",emptyCommentText:"Enter comments here.",emptyFooterText:"Enter map footer here.",creatingPdfText:"Creating PDF...",includeLegendText:"Include legend?",rotationText:"Rotation",printProvider:null,sourceMap:null,printMapPanel:null,showTitle:true,mapTitle:null,mapTitleYAML:"mapTitle",showComment:true,mapComment:null,mapCommentYAML:"mapComment",showFooter:true,mapFooter:null,mapFooterYAML:"mapFooter",showLegend:true,mapLegend:null,showLegendChecked:false,showRotation:true,printRotationPage:null,printRotationExtent:null,printRotationExtentOptions:null,addMapOverlay:true,busyMask:null,form:null,autoEl:"center",cls:"x-panel-body x-panel-body-noheader",initComponent:function(){var printMapPanelOptions={sourceMap:this.sourceMap,printProvider:this.printProvider};if(this.printMapPanel){if(!(this.printMapPanel instanceof GeoExt.PrintMapPanel)){printMapPanelOptions.xtype="gx_printmappanel";this.printMapPanel=new GeoExt.PrintMapPanel(Ext.applyIf(this.printMapPanel,printMapPanelOptions));}}else{this.printMapPanel=new GeoExt.PrintMapPanel(printMapPanelOptions);}
this.sourceMap=this.printMapPanel.sourceMap;this.printProvider=this.printMapPanel.printProvider;if(this.mapLegend){this.printProvider.encoders.legends.gx_vectorlegend=function(legend){return[{name:'',classes:[]}];}}
