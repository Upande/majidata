...
function makeTable(){$('#table-data').dataTable({"bJQueryUI":false,"sPaginationType":"full_numbers","sDom":'<"H"Tlfr>rt<"F"ip>',"oTableTools":{"sSwfPath":"/static/js/tt/media/swf/copy_cvs_xls_pdf.swf"}});$('#table-data').css("display","block").fadeIn();}
